...
@endphp
@section('title',$subcategory['meta_title_'.$locale])
@section('description',$subcategory['meta_content_'.$locale])
@section('keywords',$subcategory['meta_keyword_'.$locale])
                ...
                <div class="col">
                    <div class="about-l">
                        <ul class="about-link">
                            ...
                            <li class="go-home"><a href="{{url($subcategory->category['slug_'.$locale])}}">{{$subcategory->category['name_'.$locale]}}</a></li>
                            <li class="about-p"><span>{{$subcategory['name_'.$locale]}}</span></li>
                        </ul>
                    </div>
                </div>
            </div>
