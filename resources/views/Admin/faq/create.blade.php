                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="question_fr" id="question_fr" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="question_it" id="question_it" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="question_de">Question Deutsch</label>
                                <input type="text" name="question_de" id="question_de" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea name="answer_fr" id="answer_fr" class="summernote"></textarea>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="answer_en">Answer English</label>
                                <textarea name="answer_en" id="answer_en" class="summernote"></textarea>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="answer_it">Answer Italiano</label>
                                <textarea name="answer_it" id="answer_it" class="summernote"></textarea>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="answer_de">Answer Deutsch</label>
                                <textarea name="answer_de" id="answer_de" class="summernote"></textarea>
                            </div>
                        </div>
                        <div class="col-12">
