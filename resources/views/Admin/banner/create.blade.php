                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="alt_fr" id="alt_fr" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="alt_it" id="alt_it" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="alt_de">Alt Deutsch</label>
                                <input type="text" name="alt_de" id="alt_de" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="image">Banner Image</label>
                                <input type="file" required accept="image/*" name="image" id="image" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
